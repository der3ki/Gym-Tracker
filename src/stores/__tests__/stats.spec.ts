...
describe('statsStore', () => {
  ...
  beforeEach(() => {
    ...
    setStorageOverride('routines', routineStorage)
    setStorageOverride('training-weeks', weekStorage)
    setIdGeneratorOverride(sequentialIdGenerator)

    // Pre-load routine into storage
  ...
  describe('getPersonalRecords', () => {
    it('should return empty array when no weeks exist', async () => {
      ...
      // Act
      const prs = await statsStore.getPersonalRecords()
  ...
  describe('getExerciseProgressions', () => {
    it('should return empty array when no weeks exist', async () => {
      ...
      // Act
      const progressions = await statsStore.getExerciseProgressions('r1')
